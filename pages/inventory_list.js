  ...
  return (
    ...
    <div>
      ...
      <div className="flex justify-center items-center">
        ...
        <div className="">
          <h1 className="sans-serif text-4xl font-bold">Inventory List</h1>
        </div>
      </div>
      <div className="flex justify-center items-center">
      ...
      <div>
        {currentItems.map(item => (
          <div key={item.id} className="flex flex-row border-b border-gray-200 w-full">
            ...
            <div className="flex justify-center items-center border-r border-gray-400 p-2 flex-1">
              {editingId === item.id ? (
                <TextField
                  ...
                  size="small"
                  value={editCaseCost}
                  onChange={(e) => setEditCaseCost(e.target.value)}
